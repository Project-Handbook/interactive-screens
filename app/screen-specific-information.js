...
var ScreenSpecificInformation = (function () {
    function ScreenSpecificInformation(title, /* Title to show in the top of the screen */ address, /* Address to show in the sidebar */ telephoneNumber, /* Telephone number in the sidebar */ telephone_deliveries, /* Telephone number for the delivery man */ postal_code, /* Postal code in the sidebar */ city, /* Nearest city shown in the sidebar */ departments, /* List of nearby departments */ nearest_department, /* Name of the department nearest the screen */ department_code, /* Department code for People tab default */ department_name, /*Department name for People tab default */ longitude, /* Coordinate for the sceen */ latitude, /* Coordinate for the screen  */ 
        ...
        opening_hours, /* opening hours */ opening_hours_enabled, /* Whether or not the opening hours should be displayed or not */ calendar_polypoly_id, /*Polypoly id to fetch calendar in home tab*/ news_feed_polypoly_id, /*Polypoly id to fetch news feed in home tab*/ footer_text) {
        ...
        if (department_name === void 0) { department_name = ""; }
        ...
        if (footer_text === void 0) { footer_text = ""; }
        this.title = title;
